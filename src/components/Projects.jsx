    ...
    const projects =[
        {
            id: 1,
            image: proj1,
            title: 'Subject Loading for Teachers',
            desc: 'Smart Subject Loading for Teachers at Balagtas National Agricultural High School',
        ...
        },
        {
            ...
            desc: 'To make the documents more organized and easier to share',
            tech: ['Javascript', 'HTML', 'CSS','ASP.Net','Microsoft SQL']
        },
        {
            id: 3,
            image: proj3,
            title: 'POS Goods',
            desc: 'Make Sales faster online',
            tech: ['Javascript', 'HTML', 'CSS','ASP.Net','Microsoft SQL']
        },
        {
            id: 4,
            image: proj4,
            title: 'ERP System',
            desc: 'ERP System for Accounting, Inventory, HR, Manufacturing and Sales module ',
            tech: ['Javascript', 'HTML', 'CSS','Odoo','Microsoft SQL']
        }
    ]
