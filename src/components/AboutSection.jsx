        ...
        <div className='max-w-7xl mx-auto px-4 md:grid md:grid-cols-2 gap-12 items-center py-16 xl:px-16 relative z-10'>
            <div>
                ...
                <p className='text-gray-400 text-base lg:text-lg mb-10 leading-relaxed'>
                    Outside of work, I enjoy playing computer games, basketball, listening to music, and playing guitar. I also like travelling and exploring different places whenever I have the time and money. I am married with one son and currently living in Bocaue, Bulacan, Philippines. <br>
                    </br> <br>
                    </br>My native language is Tagalog, I am fluent in English, and I have basic knowledge of German. I can also drive both motorcycle and car. I usually dedicate around two hours each day for self-improvement, whether it’s learning new technical skills, improving my current stack, or focusing on personal development.
                </p>
                <div className='grid grid-cols-3 gap-6 max-w-xl'>
                    <div className='text-center rounded-2-xl bg-[#111a3e] border border-[#1f1641] p-5 transition-all duration-300 hover:border-primary/50'>
                        <h3 className='text-primary font-bold text-2xl md:text-3xl'>+8</h3>
